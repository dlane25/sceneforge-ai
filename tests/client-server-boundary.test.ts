...
const guardedModules = [
  ...
  'lib/media/adapters/google-cloud-tts-provider.ts',
  'lib/media/providers/google-tts-transport.ts',
  'lib/storage/gcs.ts',
  'lib/storage/google-cloud-media-storage.ts',
  'lib/export/gcs-media-materializer.ts',
